...
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『电棍中心』"; Text ="核对用户ID中♧"; Duration = 2; })
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "『电棍中心』"; Text ="用户ID核对完毕♣"; Duration = 4; })

local ui = loadstring(game:HttpGet("https://raw.githubusercontent.com/dingding123hhh/hun/main/jmlibrary1.lua"))();        
local win = ui:new("电棍中心")
--
...
about:Label("电棍中心")
about:Label("作者QQ：1480077284")
about:Label("QQ主群：876730837")
about:Label("QQ2群： 876730837")
about:Label("作者：🐱")
about:Label("进群发最新注入器")
about:Label("脚本持续更新中")
about:Label("脚本疯狂优化中")
...
about:Label("感谢所有支持电棍中心的人")
about:Label("已修复完bug")
about:Label("♦")
about:Label("       ")
about:Label("感谢大家支持电棍中心")
about:Label("十分感谢")
about:Label("感谢 lishichuan(丁丁王) 提供源码")
